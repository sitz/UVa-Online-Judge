...
template <class _T>
void reduce(_T &n, _T d, _T &r, bool nod)
{
	// Requires: pwr
	_T c = 0;
	if (n % d)
...
template <class _T>
_T nod(_T a)// returns number of divisors
{
	// Requires: reduce
	if (memonod[a] != -1)
	{
...
template <class _T>
_T sod(_T a)// returns sum of divisors
{
	// Requires: reduce
	if (memosod[a] != -1)
	{
