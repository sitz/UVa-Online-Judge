...
int nc, na, cmat[128][128], amat[128][128], id_of[128][128], N, cat[128], an[128], cmatch_[128], cnext[128], amatch[128], corder[128][128], cmp_cat;
...
void solve()
{
	...
	for (int i = 0; i < N; i++)
	{
		...
		printf("%s%s", cname[cat[i]], aname[an[cmatch_[i]]]);
	}
	printf("\n\n");
}
